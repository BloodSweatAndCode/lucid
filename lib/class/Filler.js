class Filler {
	 ...
	 * @example
	 * // creates a filler
	 * const { Filler } = require('lucid');
	 * const filler = new Filler(20, 100, 10, 50);
	 * @property {Number} x - The x position of the filler.
	 * @property {Number} y - The y position of the filler.
	 * @property {Number} w - The width of the filler.
	 * @property {Number} h - The height of the filler.
	 */
	constructor(x, y, w, h) {
		this.x = x;
		this.y = y;
