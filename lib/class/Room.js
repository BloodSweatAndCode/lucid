...
class Room {
	 ...
	 * @property {Array} bgTiles - An array of background {@link Tiles} instances
	 * @property {Array} fgTiles - An array of {@link Tiles} instances
	 * @property {Array} objTiles - An array of {@link ObjectTiles} instances
	 * @property {Boolean} musicLayer1 - Is music layer 1 enabled?
	 * @property {Boolean} musicLayer2 - Is music layer 2 enabled?
	 * @property {Boolean} musicLayer3 - Is music layer 3 enabled?
	 * @property {Boolean} musicLayer4 - Is music layer 4 enabled?
	...
	/**
	 * Updates the size of all tiles in the room and reloads them into either
	 * a Tiles or ObjectTiles object.
	 * @param {String} [center=0] - The base value with which to fill the tile arrays
	 * @returns {null}
	 */
