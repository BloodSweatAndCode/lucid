...
/**
 * @class
 * @property {String} [name='Lucid Dream Default'] - The name of the Mod
 * @property {String} [version='0.0.1'] - The version of the Mod (X.Y.Z)
 * @property {String} [author='Lucid Dream Author'] - The author of the Mod
 * @property {Array} [dependencies=[ { name: 'Everest', version: '1.0.0' } ]] - An Array containing the dependencies of the Mod
 * @property {Array} [chapters=[]] - An Array of {@link Chapter} instances
 * @property {Dialog} [dialog=new Dialog()] - An instance of {@link Dialog}
 */
class Mod {
	/**
	 * @constructor
